@echo off
mode 110,40
title cyberstar multitool
cls
echo.
echo [40;32mmltitool made by cyberstar
echo [40;32mCopyright ([40;37mC[40;32m) cyberstar , inc. All right reserved.
:login
echo.
echo.
...
goto login
:NEXTY
echo [40;32mOk [40;33m%name%, [40;32mWelcome to stars multitool skid
echo.
echo.
...
echo.
echo.
echo [40;32m------------------------------ [40;34mREMEMBER, DON'T DO GOTO JAIL![40;32m---------------------------
echo.
echo.
echo.
echo                    `                      
...
echo [40;34m       :+oyNNNNNNNNNNNNNdmNy-                   [*][40;37mAuthor : ~ cyberstar
echo [40;34m      `+mNNNmy++//+shmNNNNNNNh:                 [*][40;37mType : multitool     
echo [40;34m     -yNNNd:         `:ymNNNNmmh.               [*][40;37mTeam : cyberstar Team
echo [40;34m     :mNNN-             .sNNNmsdd-              [*][40;37mOperating System : skid os
echo [40;34m    `/hNNN`               :dNNNNNm-             [*][40;37mPC Name : skidders pc
echo [40;34m      `mmNNy`                -odNNNo`           [*][40;37mUsername : skid
...
echo [40;34m                    `:odmy:                     [+][40;37mContact : censored
echo [40;34m                        .+dh.                   [+][40;37mEmail : censored
echo [40;34m                           /d-                  
...
:NEXT     
echo Choice :
echo   ______ __/ /  ___ ____  __ _  __ __/ / /_(_) /____  ___  / /
echo  / __/ // / _ \/ -_) __/ /  ' \/ // / / __/ / __/ _ \/ _ \/ / 
echo  \__/\_, /_.__/\__/_/   /_/_/_/\_,_/_/\__/_/\__/\___/\___/_/  
echo     /___/                                                     
echo.
echo.
echo.
...
echo [40;34m[2] [40;37mdos attack
